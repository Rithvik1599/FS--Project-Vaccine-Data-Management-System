...
namespace Vaccine_GUI {
	...
	/// <summary>
	/// Summary for DeletePerson
	/// </summary>
	public ref class DeletePerson : public System::Windows::Forms::Form
	{
	public:
		DeletePerson(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(161, 234);
			...
			this->button1->Click += gcnew System::EventHandler(this, &DeletePerson::button1_Click);
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(298, 137);
			this->textBox1->Margin = System::Windows::Forms::Padding(2);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(191, 20);
			this->textBox1->TabIndex = 7;
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &DeletePerson::textBox1_TextChanged);
			// 
			// label2
			// 
			...
			this->label2->Size = System::Drawing::Size(204, 22);
			this->label2->TabIndex = 6;
			this->label2->Text = L"Enter RID to be deleted";
			// 
			// label1
			// 
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Algerian", 24, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(205, 55);
			this->label1->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(304, 35);
			this->label1->TabIndex = 5;
			this->label1->Text = L"Delete an Entry";
			// 
			// button2
			// 
			this->button2->Font = (gcnew System::Drawing::Font(L"Times New Roman", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(382, 234);
			...
			this->button2->Click += gcnew System::EventHandler(this, &DeletePerson::button2_Click);
			// 
			// DeletePerson
			// 
			...
			this->ClientSize = System::Drawing::Size(712, 528);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->textBox1);
			this->Controls->Add(this->label2);
			this->Controls->Add(this->label1);
			this->Name = L"DeletePerson";
			this->Text = L"DeletePerson";
